...
class Photo(models.Model):
    ...
    frontpage = models.BooleanField(default=False) #Basically false

    title = models.CharField(max_length=200)
    slug = models.SlugField(max_length=200, blank=True, editable=False) # editable = visible true
    ...
    def save(self,*args,**kwargs):
        ...
        self.replace_image()  # invite the method
    ...
    def resize_image(self):
        ...
        max_size = 1500  # x and y dimension
        if img.size[0] > max_size or img.size[0] > max_size:
            img.thumbnail((max_size, max_size))
            img.save(image_path)  # resize and save
